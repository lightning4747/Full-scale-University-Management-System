...
// GET /classes — department-based isolation
// Admin: all classes
// Teacher/Student with departmentId: only classes in their department
...
router.get("/:id", async (req, res) => {
  try {
    ...
    if (!Number.isFinite(classId))
      return res.status(400).json({ error: "cannot found class" });
