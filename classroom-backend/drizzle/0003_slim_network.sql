CREATE TYPE "public"."enrollment_status" AS ENUM('ongoing', 'completed', 'dropped');--> statement-breakpoint
...
ALTER TABLE "enrollments" ADD COLUMN "status" "enrollment_status" DEFAULT 'ongoing' NOT NULL;--> statement-breakpoint
