...
--> statement-breakpoint
ALTER TABLE "subjects" ADD CONSTRAINT "subjects_departmentsId_departments_id_fk" FOREIGN KEY ("departmentsId") REFERENCES "public"."departments"("id") ON DELETE restrict ON UPDATE no action;